 ...
 */
final class Version20250524134701 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE comment ADD user_id INT DEFAULT NULL, CHANGE author author VARCHAR(255) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE comment DROP user_id, CHANGE author author VARCHAR(255) NOT NULL
        SQL);
    }
}
